---
title: Introduction
description: "Pictify API: generate images (PNG, JPG, WebP), multi-page PDFs, GIFs, and MP4 video from HTML templates — emailed to each recipient with delivery status"
---

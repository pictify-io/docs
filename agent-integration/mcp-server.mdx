...
The server ships 36 tools. The most-used ones are detailed below; the full set:
...
| Video | `pictify_list_video_templates`, `pictify_get_video_template_variables`, `pictify_render_video` (MP4 or GIF), `pictify_generate_video_template` (AI-designed), `pictify_create_video_template` (agent-authored Remotion scene, compile-gated) |

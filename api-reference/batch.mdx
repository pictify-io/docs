...
<CodeGroup>
```bash cURL
curl -X POST https://api.pictify.io/templates/tmpl_abc123/batch-render \
...
<CodeGroup>
```bash cURL
curl https://api.pictify.io/templates/batch/batch_xyz789/results \
  -H "Authorization: Bearer $API_KEY"
```
...
<CodeGroup>
```bash cURL
curl -X POST https://api.pictify.io/templates/batch/batch_xyz789/cancel \
  -H "Authorization: Bearer $API_KEY"
```
